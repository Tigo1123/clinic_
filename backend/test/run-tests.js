...
for (const [command, args] of [
  ...
  ['node', ['prisma/seed.js']],
  ['node', ['--test', '--test-concurrency=1', 'test/access-token.test.js', 'test/clinic-time.test.js', 'test/integration.test.js', 'test/medicine-management.test.js', 'test/medicine-migration.test.js', 'test/mfa.test.js', 'test/password-policy.test.js', 'test/patient-file-projection.test.js', 'test/patient.test.js', 'test/reference-bootstrap.test.js', 'test/seed-security.test.js', 'test/smtp-config.test.js', 'test/socket-revocation.test.js']]
]) {
