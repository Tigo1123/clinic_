...
export function PatientRegister() {
  ...
  {step === 3 && <div className="onboarding-grid" dir="ltr"><Field label={t('phone')} type="tel" value={form.phone} onChange={value => update('phone', value)} error={fieldErrors.phone} autoComplete="tel"/><Field label={t('email')} type="email" value={form.email} onChange={value => update('email', value)} error={fieldErrors.email} autoComplete="email"/></div>}
